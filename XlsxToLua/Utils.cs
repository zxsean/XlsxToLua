...
public class Utils
{
    ...
    public const string __PIC = "+++++/+.```````+sso+/://+sooooooo++////:-.`````..----.--:::-----.````````````.`````````````--`      \r\n" +
                                "+++++++:.``````o+//+//:/syyyo+++++/:......-:///////+/::///:-----:::-``````````````````````.-.       \r\n" +
                                "://++++++-````.:+/:----ssyyyyo+/oo+ys++:-:/+o+///::-.....-::::----:/+/:////+o+/:``````````--`       \r\n" +
                                "---:+/++++`.-:-`-------:+syyyy++++ooyyys+oos/------..........---...-://++////sys.````````.-.        \r\n" +
                                "---//---/+:.````--------`./ys/`:++/+yysss+//...........................-+++osyyh-....````--         \r\n" +
                                "++/s:://-.``````--------```:-...+++syss+/-:...-........................../o+o+///-..````--`         \r\n" +
                                "yyyyo+:.```````-++/-----```.-::/+ooos+:.-.-.``..`.......```..``...........-o+/:----..``.-.         `\r\n" +
                                "++y+oo/.``-+++ohhhhs///:``.--:++oo++:-..-..``./:...................-.......-++o+/::-..`--`         .\r\n" +
                                ...
                                "dyo///-.`````/ooso/-----`./:/:+++---:---/-//--::-//:----:o/--/://+/--/----.:s+/++--o:::----...``--oo\r\n" +
                                "hoo++/:.``````/+s+------.:-/:.///---/---/-/+/:-/:-///::--++/-/:oo+++:/:-:-./ss/+o:.++::::::------/ss\r\n" +
                                "yooooo/.```````./:-------:+/-.:+/-:-+::-//:--///+::///+/:///::+hdshho//-/:.o+s/-++-/+/++//:::::::oo+\r\n" +
                                "oooooo/.````````----------/-:.-/+--/o+:::+-...:+++/:/::///+:+/hhdhddy+//:-/s:+/--s-:+:ooooo+///:::::\r\n" +
                                "/ooooo:.````````--------`.:-:--+y/-:+s/::/--::/oo+://+/:://:/+ddddddho////s+:+o--+:-o/::/++oooo+++//\r\n" +
                                ":++oso-.````````--------`-:--:-+ss/-:+s//++o-++o+o-.-:/::////sddddddys+//:s+/:o/-:/-///-...-:/+ooooo\r\n" +
                                "--::/+-.````````--------`-/--::oo+o/-:os///-`.:::.````.-..://+shddhs++/-.+y+:-/o--:-:.::-......-:/+o\n" +
                                "-------.```.--::/+++/-::-:/:/:+s/+/:/-:+///-```````````````-:``.--.`:+:o+sso---o/--/:..-:....`.....-\n" +
                                "------:/++/ssssso////--/:-/++/s+/o:--:://.-/-```````````````````````-/os:oos:--+o:-+::..--.........`\n" +
                                "::::/:-----------------/-:+++so/+o----:////+:.`````````````````````-:/+o:++s-:--///+:::..--.........\n" +
                                "::::------------------::://+so+//s--.-/-///yo/-``````````````````.:/-+-+::/o-/:---/+:::-..:-........\n" +
                                "--------------------://://+oo+//-s:-..o//::ss/so:.`````.```````./+:::+-:/:+--+o:.--:---:..:-........\n" +
                                "-------------:::::::/://+os//+:/-s+:-.oo:::o+o+sso+:.````````.:/s/:/:o:-//o--o+/:..-:`.:``--`.......\n" +
                                "---------:::-:/+oooo+++//+o-:o::/oso:-+s/::+/++ososo::-....---:+++-/:oo::/:-/+:++::-:-.:  ::    ``..\n" +
                                "---------------:/::-----/++-+o+//+ss+-/s//:o:/+/o+ss-----::-../+:+-/-+s//--+so//oo+/-:-:`.//..`     \n" +
                                "----------------::------/+:-+/://+ooo///::://-/+/+s/-........-+:-/-/-:oo--/sos+:ss+o+-:: -.:``.-.`  \n" +
                                "-----------------:-----///://-.-/+oo://:/-:://:++oo-`````````-o--:-/--++//-oo+--/oo+o+:---`:..-.....\n" +
                                "-----------------:----///+-+--.+-:++-:/:++:/:+++s+:``````````:o--:-/-.-:/+.//-``.:/+++o+:.-:-.......\n" +
                                "---------------------///+:::.--o--:+::+-:so///++++.``````````.o:/:./..-+-/:+- ```    ./so//--`  ```.\n" +
                                "---------------------///+-+-..:o---////:-sso+///+/````````````-oo--/..///+o:`         `oss+:-.      \n" +
                                "------------:-------://o/:o-.-/+---:+/-:-ooos:.-/.``````````:+os+-+-.-+ooo+.           :osso/-.`    \n" +
                                "------------::------//oo:+o-..++---::--:o/oso---.````````./osooo//+.-/+soo:`   ``      `+ooos/--.`  \n" +
                                "-------------:/-----//s//o+..-s:-----:-+s/oos-.````````-+ssssooooo-:/ooooo- `.`         :+ooos/---.`\n" +
                                "--------------//---:/++/+s:.-++----:++:o/+oo+.```````.+sssssssoooo-/+oooo+..`           `/oo:so/----\n" +
                                "--------------///:-:/++soo-.:+-:///os/+.oooo+``````./ysssssss+:--:::::--//.              `/o-//o/---\n" +
                                "--------------/::-//o+/s+/--:/+//-+o/s+ /ooo+    `:syysssso/-`   .-``  -:`                 ::-/+/---\n" +
                                "----------------:o+/+//++:o::///-+//+s/ `oooo   `+yyyss+:.`      `-   --.                 `-.-:-+---\n" +
                                "--:::--------:///o/+///+:os:-/-/://oss-  -oss  -oo++/:.           .  --`                 `-`:---+-:-\n" +
                                "/--://:::--:////+o+////:os::/:-:+oosss`   /yy-::::-.`              `--`                 `- .o---/./-\n" +
                                ":/:--://:-///////++//:-os/-/s+-:+s/os+     +/:---.                 --  `.``---.         ` `-+---/---\n" +
                                "://+::::-::::::::/://-/ss--/++-o/s/oos     ./---.                 .-:+ooooooooo+:`       `.+:--+:---\n" +
                                "///o/::-:::::::::/::++os+-::::-s/+oo+s-    -:--.                 .-+ssoooooooooooo-     `-:+--/o---.\n" +
                                "//+s+::::::::::::--/::o+/-:::::++:osos/    ---.                 .-:sssoo//+oooooooo/`   ::-/-:+:--` \r\n" +
                                "-:+++::/::::::::::/-/-/+/:::///:o//+soo/`  ---               `.-:/osyo:````-+oooooooo- ::-/+/:---` .\r\n" +
                                "-:+++::/:::::::://-:/.-+//:::/+o/++/oooo+. --`            `.-:/+yyysy-```````.:+oooooo//--o:---.``.`\r\n";
}
